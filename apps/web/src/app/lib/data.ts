...
export const HOST_LISTINGS: Listing[] = [
  {
    id: 'h1',
    property: FEATURED[0],
    status: 'Live',
...
export const CHAT_THREADS: ChatThread[] = [
  {
    id: 'c1',
    name: 'Maria López',
    lastMsg: 'Perfect — see you Friday!',
    time: '2m',
    unread: 2,
    verified: true,
    property: 'Cliffside Villa',
    online: true
  },
  {
    id: 'c2',
    name: 'James Patterson',
    lastMsg: 'Could we get a late checkout?',
    time: '14m',
    unread: 1,
    verified: true,
  ...
  },
  {
    id: 'c3',
    name: 'Yuki Tanaka',
    lastMsg: 'Thanks again for everything!',
    time: '1h',
    unread: 0,
    verified: false,
    property: 'Cappadocia Suite',
    online: false
  },
  {
    id: 'c4',
    name: 'Elena Rossi',
    lastMsg: 'The wifi password worked, thanks',
    time: '3h',
    unread: 0,
    verified: true,
    property: 'Aegean Stone',
    online: false
  },
  {
    id: 'c5',
    name: 'Marcus Chen',
    lastMsg: 'I just sent the deposit',
    time: 'Yest',
    unread: 0,
    verified: true,
  ...
  },
  {
    id: 'c6',
    name: 'Aisha Karim',
    lastMsg: 'Looks beautiful in the photos!',
    time: 'Mon',
    unread: 0,
    verified: false,
    property: 'A-Frame Cabin',
    online: true
  },
];
